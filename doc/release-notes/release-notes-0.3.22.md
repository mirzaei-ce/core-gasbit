Download URL: https://sourceforge.net/projects/gasbit/files/Gasbit/gasbit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 GBT fee schedule (users still pay 0.01 GBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #gasbit00 - #gasbit99
