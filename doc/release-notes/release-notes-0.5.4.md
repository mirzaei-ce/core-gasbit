Gasbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/gasbit/files/Gasbit/gasbit-0.5.4/
...
http://gitorious.org/gasbit/gasbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Gasbit-Qt notifications under Growl 1.3.
Increase required age of Gasbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGasbit properly when installing Gasbit-Qt over it. (Windows)
