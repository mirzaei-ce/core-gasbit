Gasbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/gasbit/files/Gasbit/gasbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Gasbit
...
New/changed settings (command-line or gasbit.conf file)
--------------------------------------------------------
