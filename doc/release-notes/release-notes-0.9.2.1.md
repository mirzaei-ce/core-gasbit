Gasbit Core version 0.9.2.1 is now available from:

  https://gasbit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 GBT to 0.01 GBT
...
- Fix "Start gasbit on system login"
