Gasbit Core version 0.9.4 is now available from:

  https://gasbit.org/bin/0.9.4/
...
this update is incompatible with the Gasbit system and could lead to consensus
forks.

Gasbit Core released binaries from https://gasbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~gasbit/+archive/ubuntu/gasbit
- A third-party or self-compiled Gasbit Core

upgrade to Gasbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
