...
unlocked to sign the Gasbit-Qt.app bundle.
...
allowing somebody to distribute a Gasbit-Qt.app or gasbit-qt-setup.exe with a valid
...
that the gasbit-qt.exe file inside the installer had not been tampered with.
