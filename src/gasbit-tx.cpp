...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Gasbit Core gasbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gasbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gasbit transaction") + "\n" +
              "  gasbit-tx [options] -create [commands]   " + _("Create hex-encoded gasbit transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gasbit transaction
