...
#if defined(NDEBUG)
# error "Gasbit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Gasbit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s GBT additional fees, %d delta bytes\n",
