...
#ifndef GASBIT_QT_GASBITUNITS_H
#define GASBIT_QT_GASBITUNITS_H
...
/** Gasbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GasbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GasbitUnits(QObject *parent);

    /** Gasbit units.
      @note Source: https://en.gasbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        GBT,
...
typedef GasbitUnits::Unit GasbitUnit;

#endif // GASBIT_QT_GASBITUNITS_H
