...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/gasbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Gasbit Core"),
     ...
     * override -datadir in the gasbit.conf file in the default data directory
     * (to be consistent with gasbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
