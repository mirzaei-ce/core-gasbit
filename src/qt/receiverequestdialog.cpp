...
#include "config/gasbit-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatGasbitURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + GasbitUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatGasbitURI(info));
}
