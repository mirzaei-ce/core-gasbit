...
#ifndef GASBIT_TEST_SCRIPTNUM10_H
#define GASBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Gasbit Core 0.10.0, for cross-comparison.
 */
public:
